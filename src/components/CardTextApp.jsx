...
const CardTextApp = () => {
  return (
    <div className='ms-3 me-2 text-center'>
      ...
      <h6 className='mt-2 text-start'>Trancas, en el corazón de las Cumbres Calchaquíes, te invita a descubrir un remanso de paz y belleza natural. Este destino te ofrece una experiencia única para conectar con la naturaleza, la historia y la cultura.<br/>
